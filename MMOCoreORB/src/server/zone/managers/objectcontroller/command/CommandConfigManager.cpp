...
void CommandConfigManager::registerCommands() {
	...
	commandFactory.registerCommand<GroupMessageSelectionCommand>(String("groupMessageSelection").toLowerCase());
	commandFactory.registerCommand<ListFactionBasesCommand>(String("listFactionBases").toLowerCase());
	commandFactory.registerCommand<LocateStructureCommand>(String("locateStructure").toLowerCase());
	commandFactory.registerCommand<MilkCreatureCommand>(String("milkCreature").toLowerCase());
