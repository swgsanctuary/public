...
public:
	...
	const static int CLOAKOFPAIN = 0x8;
...
protected:
	 ...
	 */
	int getHitChance(TangibleObject* attacker, CreatureObject* targetCreature, WeaponObject* weapon, int damage, int accuracyBonus, bool isForceAttack);
