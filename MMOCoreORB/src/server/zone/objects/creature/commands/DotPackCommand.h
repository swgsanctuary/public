...
public:
	...
	int doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
		...
		/* Save for potential PVP reduction in the future
		if ((creature->isPlayerCreature() || creature->isPet()) && (creatureTarget->isPlayerCreature() || creatureTarget->isPet()))   // 25% reduction of DOT damage in PVP
			dotPower *= 0.75;
		*/
		...
		// Check to see if we should apply GCW or BH TEF
