...
int PlantObjectImplementation::getCriticalAttribute(int index) {
	switch (index) {
	case 7: return CraftingManager::DR; // 3
	case 6: return CraftingManager::FL; // 5
	case 5: return CraftingManager::PE; // 7
	case 4: return CraftingManager::UT; // 10
	case 3: return CraftingManager::SR; // 9
	case 2: return CraftingManager::MA; // 6
	case 1:
	default: return CraftingManager::OQ; // 8
	}
}
