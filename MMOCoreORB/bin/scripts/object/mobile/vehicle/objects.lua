...
-- fix objects 
object_mobile_vehicle_base_shared_base_vehicle = SharedCreatureObjectTemplate:new {
	clientTemplateFileName = "object/mobile/vehicle/base/shared_base_vehicle.iff"
}

ObjectTemplates:addClientTemplate(object_mobile_vehicle_base_shared_base_vehicle, "object/mobile/vehicle/base/shared_base_vehicle.iff")

object_mobile_vehicle_base_shared_vehicle_base = SharedCreatureObjectTemplate:new {
	clientTemplateFileName = "object/mobile/vehicle/base/shared_vehicle_base.iff"
}

ObjectTemplates:addClientTemplate(object_mobile_vehicle_base_shared_vehicle_base, "object/mobile/vehicle/base/shared_vehicle_base.iff")
