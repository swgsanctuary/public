...
includeFile("tangible/loot/loot_schematic/landspeeder_organa_schematic.lua")
includeFile("tangible/loot/loot_schematic/basilisk_war_droid_schematic.lua")
...
-- krayt Backpack
includeFile("tangible/loot/loot_schematic/clothing_backpack_krayt_skull_schematic.lua")
