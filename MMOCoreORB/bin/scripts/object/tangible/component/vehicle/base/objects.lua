...
object_tangible_component_vehicle_base_shared_vehicle_base = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/component/vehicle/base/shared_vehicle_base.iff"
}

ObjectTemplates:addClientTemplate(object_tangible_component_vehicle_base_shared_vehicle_base, "object/tangible/component/vehicle/base/shared_vehicle_base.iff")
