...
object_draft_schematic_structure_diner_house_schem = object_draft_schematic_structure_shared_diner_house_schem:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Deed for: Diner House",
   ...
   targetTemplate = "object/tangible/deed/player_house_deed/diner_house_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_structure_diner_house_schem, "object/draft_schematic/structure/diner_house_schem.iff")
