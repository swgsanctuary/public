object_draft_schematic_armor_armor_marauder_s02_helmet = object_draft_schematic_armor_shared_armor_marauder_s02_helmet:new {
   ...
   targetTemplate = "object/tangible/wearables/armor/marauder/armor_marauder_s02_helmet.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_marauder_s02_helmet, "object/draft_schematic/armor_marauder_s02_helmet.iff")
