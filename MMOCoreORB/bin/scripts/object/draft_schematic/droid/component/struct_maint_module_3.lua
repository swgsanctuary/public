...
object_draft_schematic_droid_component_struct_maint_module_3 = object_draft_schematic_droid_component_shared_struct_maint_module_3:new {
   ...
   resourceTypes = {"aluminum_duralumin", "crystalline_vertex", "object/tangible/component/item/shared_electronics_gp_module.iff", "object/tangible/component/item/shared_electronics_memory_module.iff"},
   resourceQuantities = {25, 20, 1, 3},
   contribution = {100, 100, 100, 100},


   targetTemplate = "object/tangible/component/droid/struct_maint_module_3.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_droid_component_struct_maint_module_3, "object/draft_schematic/droid/component/struct_maint_module_3.iff")
