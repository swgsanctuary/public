...
ObjectTemplates:addTemplate(object_draft_schematic_droid_component_personality_module_stupid, "object/draft_schematic/droid/component/personality_module_stupid.iff")
