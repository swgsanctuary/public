...
function TalusKahmurraBiogenticResearchStationScreenPlay:spawnMobiles()
	...
	spawnMobile("talus", "genetically_enhanced_kahmurra", 300, 1.3, -6.8, -13.1, 280, 4795362)
	spawnMobile("talus", "frenzied_kahmurra", 300, -6.0, -6.8, -14.1, 32, 4795362)
	spawnMobile("talus", "genetically_enhanced_kahmurra", 300, -2.7, -6.8, -6.2, 124, 4795361)
	spawnMobile("talus", "frenzied_kahmurra", 300, -6.8, -6.8, -7.5, -120, 4795361)
	spawnMobile("talus", "genetically_enhanced_kahmurra", 300, -4.5, -6.8, -0.3, 0, 4795361)
	spawnMobile("talus", "genetically_enhanced_kahmurra", 300, 2.4, 0.3, -3.8, -93, 4795359)
	spawnMobile("talus", "genetically_enhanced_kahmurra", 300, 0.2, 0.3, 7.6, -1, 4795357)
	spawnMobile("talus", "genetically_enhanced_kahmurra", 300, -4796.3, 16.6, -4753.1, 122, 0)
	spawnMobile("talus", "genetically_enhanced_kahmurra", 300, -4780.3, 17.2, -4737.9, 41, 0)
end
