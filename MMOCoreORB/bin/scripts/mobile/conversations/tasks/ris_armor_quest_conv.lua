...
-- this overrides the default quest to open the new BH part
completed_all_quests = ConvoScreen:new {
	id = "completed_all_quests",
	customDialogText = "Let me have a closer look at your plans so far... yes, yes, this will work.  It just needs one more thing.  This kind of armor as you may have noticed requires strength as well as flexibility.  There is an item big enough and strong enough, but not that common.  Have you ever heard of a varactyl?  Feathered lizard mounts, native to Utapau and Kashyyyk.  However those planets are not easy to get to if at all.  The feathers they grow can be modified so the barbs can be used in some armor such as your little project.  If you can find some, somewhere, that will do.  Wait, I think I know of a person who can help.  A wookiee, refugee from Kashyyyk, near Theed palace.  He might be able to sort you out...",
	stopConversation = "false",
	options = {
	{"Ok, I will head to Theed right away!", "end1"},
	}
}
risArmorQuestConvoTemplate:addScreen(completed_all_quests);
...
end1 = ConvoScreen:new {
	id = "end1",
	customDialogText = "Ciirvevgabev, I just remembered his name, go talk to him.",
	stopConversation = "true",
	options = {
	
	}
}
risArmorQuestConvoTemplate:addScreen(end1);

quest_7_query = ConvoScreen:new {
	id = "quest_7_query",
	customDialogText = "Go get me a varactly feather, idiot, stop bothering me",
	stopConversation = "true",
	options = {
	
	}
}
risArmorQuestConvoTemplate:addScreen(quest_7_query);

quest_7_complete = ConvoScreen:new {
	id = "quest_7_complete",
	leftDialog = "@quest_armorsmith:armorsmith_quest", -- Welcome back, my student! There is nothing more I'm willing to teach you about R.I.S. armor crafting. Practice, practice. You'll get it right one of these days.
	stopConversation = "false",
	options = {}
}
risArmorQuestConvoTemplate:addScreen(quest_7_complete);
...
buy_painting1 = ConvoScreen:new {
	id = "buy_painting1",
	customDialogText = "I do not blame you, it does cost one million credits, are you sure?",
	stopConversation = "false",
	options = {
		{"Yes, please", "buy_painting2"}
	}
}
risArmorQuestConvoTemplate:addScreen(buy_painting1);

buy_painting2 = ConvoScreen:new {
	id = "buy_painting2",
...
risArmorQuestConvoTemplate:addScreen(buy_painting2);
