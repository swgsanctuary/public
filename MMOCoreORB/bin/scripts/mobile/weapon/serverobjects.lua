...
includeFile("weapon/groups/carbine_weapons.lua")
...
includeFile("weapon/groups/nightsister_energy_lance.lua")
...
includeFile("weapon/groups/polearm_weapons.lua")
...
includeFile("weapon/groups/stun_baton_weapons.lua")
...
includeFile("weapon/groups/st_flame_weapons.lua")
