talus_world = {
	...
	lairSpawns = {
		...
		{
			lairTemplateName = "talus_meatlump_camp_neutral_medium_theater",
			spawnLimit = -1,
			minDifficulty = 5,
			maxDifficulty = 9,
			numberToSpawn = 0,
		...
		{
			lairTemplateName = "talus_putrid_decay_mite_hatchling_neutral_none",
			spawnLimit = -1,
			minDifficulty = 7,
			maxDifficulty = 11,
			numberToSpawn = 0,
		...
		{
			lairTemplateName = "talus_fynock_lair_neutral_small_02",
			spawnLimit = -1,
			minDifficulty = 7,
			maxDifficulty = 11,
			numberToSpawn = 0,
		...
		{
			lairTemplateName = "talus_dung_mite_lair_neutral_small_01",
			spawnLimit = -1,
			minDifficulty = 7,
			maxDifficulty = 11,
			numberToSpawn = 0,
		...
		{
			lairTemplateName = "talus_meatlump_outpost_neutral_medium_theater",
			spawnLimit = -1,
			minDifficulty = 8,
			maxDifficulty = 12,
			numberToSpawn = 0,
		...
		{
			lairTemplateName = "talus_dung_mite_lair_neutral_small_boss_01",
			spawnLimit = -1,
			minDifficulty = 17,
			maxDifficulty = 21,
			numberToSpawn = 0,
		...
		{
			lairTemplateName = "talus_rabid_marauder_neutral_none",
			spawnLimit = 3,
			minDifficulty = 56,
			maxDifficulty = 60,
			numberToSpawn = 0,
