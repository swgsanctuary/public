rori_world = {
	...
	lairSpawns = {
		...
		{
			lairTemplateName = "rori_varactyl_azure_neutral_none",
			spawnLimit = -1,
			minDifficulty = 12,
			maxDifficulty = 42,
			numberToSpawn = 0,
		...
		{
			lairTemplateName = "rori_varactyl_gilded_neutral_none",
			spawnLimit = -1,
			minDifficulty = 12,
			maxDifficulty = 42,
			numberToSpawn = 0,
		...
		{
			lairTemplateName = "rori_varactyl_ruby_neutral_none",
			spawnLimit = -1,
			minDifficulty = 12,
			maxDifficulty = 42,
			numberToSpawn = 0,
			...
			{
			lairTemplateName = "rori_varactyl_azure_lair_neutral_hard",
			spawnLimit = -1,
			minDifficulty = 12,
			maxDifficulty = 42,
			numberToSpawn = 0,
		...
		{
			lairTemplateName = "rori_varactyl_gilded_lair_neutral_hard",
			spawnLimit = -1,
			minDifficulty = 12,
			maxDifficulty = 42,
			numberToSpawn = 0,
		...
		{
			lairTemplateName = "rori_varactyl_ruby_lair_neutral_hard",
			spawnLimit = -1,
			minDifficulty = 12,
			maxDifficulty = 42,
			numberToSpawn = 0,
