...
includeFile("spawn/rori_varactyl_farm.lua")
includeFile("spawn/rori_varactyl_legendary_dom.lua")
includeFile("spawn/rori_varactyl_legendary_wild.lua")
includeFile("spawn/talus_boss.lua")
includeFile("spawn/talus_easy.lua")
includeFile("spawn/talus_medium.lua")
includeFile("spawn/talus_myriad1.lua")
includeFile("spawn/tatooine_easy.lua")
includeFile("spawn/tatooine_medium.lua")
includeFile("spawn/tatooine_krayt_valley.lua")
includeFile("spawn/tatooine_pelgo_surveyors.lua")
