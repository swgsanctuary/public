...
includeAiFile("templates/myriadpatrol.lua")
includeAiFile("templates/pelgoMinePatrol.lua")
includeAiFile("templates/selectattacksimple.lua")
includeAiFile("templates/stationaryTarget.lua")
includeAiFile("templates/stationaryTargetEnclave.lua")
...
includeAiFile("templates/walkPatrol.lua")
