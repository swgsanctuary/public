...
factionList = {
	...
	{ "fed_dub", true, "binayre,drall,liberation_party,lost_aqualish", "zann_consortium", 1.0 },
	...
	{ "liberation_party", true, "corsec,fed_dub,zann_consortium", "", 1.0 },
	...
	-- mandalorian
	{ "mandalorian", true, "black_krrsantans,blacksun,corellian_exchange,crimson_dawn,crymorah_syndicate,darkwalkers,guavian_death_gang,kanjiklub,kleef,pyke_syndicate,xonti_brothers,zann_consortium", "", 25 },
	{ "klatoonian", true, "black_krrsantans,xonti_brothers", "zann_consortium", .1 },
	{ "night_owls", true, "black_krrsantans,xonti_brothers", "zann_consortium", .1 },
	{ "bounty_hunter_guild", true, "black_krrsantans,xonti_brothers", "zann_consortium", .1 },

	{ "black_krrsantans", true, "xonti_brothers", "", .1 },
	{ "xonti_brothers", true, "black_krrsantans", "", .1 },

	{ "blacksun", true, "zann_consortium", "", .1 },
	{ "zann_consortium", true, "infinite_llc,blacksun", "", .1 },

	{ "guavian_death_gang", true, "kleef,pyke_syndicate", "corellian_exchange,kanjiklub", .1 },
	{ "corellian_exchange", true, "kleef,pyke_syndicate", "guavian_death_gang,crymorah_syndicate", .1 },

	{ "kleef", true, "guavian_death_gang,corellian_exchange", "pyke_syndicate,darkwalkers", .1 },
	{ "pyke_syndicate", true, "guavian_death_gang,corellian_exchange", "kleef,crimson_dawn", .1 },

	{ "crimson_dawn", true, "darkwalkers,kanjiklub", "crymorah_syndicate,pyke_syndicate", .1 },
	{ "crymorah_syndicate", true, "darkwalkers,kanjiklub", "crimson_dawn,corellian_exchange", .1 },

	{ "darkwalkers", true, "crimson_dawn,crymorah_syndicate", "kanjiklub,kleef", .1 },	
	{ "kanjiklub", true, "crimson_dawn,crymorah_syndicate", "darkwalkers,guavian_death_gang", .1 },
