...
corellia = {
	...
	planetTravelPoints = {
		...
		{name = "Vreni Island Shuttle", x = -5551.9473, z = 15.2, y = -6059.9673, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1},
...
lok = {
	...
	planetTravelPoints = {
		...
		{name = "Blood Razor Town", x = 3722, z = 12.1, y = -3055, interplanetaryTravelAllowed = 0, incomingTravelAllowed = 1}
	},
...
naboo = {
	...
	planetTravelPoints = {
		...
		{name = "Dee'ja Peak Shuttleport", x = 5331.9375, z = 325.2, y = -1576.6733, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1},
	...
	planetObjects = {
		...
		-- Dev and TC objects
		 --{templateFile = "object/tangible/terminal/terminal_character_builder.iff", ox = 0, oy = 0.710567, oz = 0, ow = 0.703629, x = -5011, z = 8.1891, y = 2876.99, parentid = 0},  -- HG Frog
		 --{templateFile = "object/tangible/travel/ticket_collector/infinity_travel.iff", ox = 0, oy = 0, oz = 0, ow = 1, x = -5047.2, z = 8.62, y = 2839.4, parentid = 0},  -- HG  Travel 1
		 --{templateFile = "object/tangible/travel/ticket_collector/infinity_travel.iff", ox = 0, oy = 0.707107, oz = 0, ow = 0.707107, x = -5011, z = 8.18787, y = 2879.21, parentid = 0},  -- HG  Travel 2
...
rori = {
	...
	planetTravelPoints = {
		...
		{name = "Battleground Staging: Rebellion", x = -3394, z = 76, y = -6905, interplanetaryTravelAllowed = 0, incomingTravelAllowed = 1},
		{name = "Battleground Staging: Imperial Army", x = -3315, z = 75, y = -7056, interplanetaryTravelAllowed = 0, incomingTravelAllowed = 1}
	},
